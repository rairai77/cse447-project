...
LANGUAGE_CONFIGS = {
    ...
    "hi": (f"{SNAPSHOT}.hi", 10_000_000),
    "bn": (f"{SNAPSHOT}.bn", 10_000_000),
    "pa": (f"{SNAPSHOT}.pa", 10_000_000),
    "mr": (f"{SNAPSHOT}.mr", 10_000_000),
    "ta": (f"{SNAPSHOT}.ta", 10_000_000),
    "te": (f"{SNAPSHOT}.te", 10_000_000),
    "gu": (f"{SNAPSHOT}.gu", 10_000_000),
    "ml": (f"{SNAPSHOT}.ml", 10_000_000),
    "tl": (f"{SNAPSHOT}.tl", 10_000_000),
    "th": (f"{SNAPSHOT}.th", 10_000_000),
    "sw": (f"{SNAPSHOT}.sw", 10_000_000),
